        ...
        return {
            ...
            source_selector = {
                ...
                sources = {
                    ...
                    {
                        source = "buffers",
                        display_name = get_icon("DefaultFile", 1, true) ..
                            "Bufs"
                    },
                    {
                        source = "git_status",
                        ...
                        source = "diagnostics",
                        display_name = get_icon("Diagnostic", 1, true) ..
                            "Diagnostic"
                    }
                }
            },
            ...
            commands = {
                system_open = function(state)
                    ...
                    (vim.ui.open or require("astronvim.utils").system_open)(
                ...
                find_in_dir = function(state)
                    ...
                    require("telescope.builtin").find_files {
                        cwd = node.type == "directory" and path or
            ...
            window = {
                ...
                mappings = {
                    ...
                    ["[b"] = "prev_source",
                    ["]b"] = "next_source",
                    F = utils.is_available "telescope.nvim" and "find_in_dir" or
                        nil,
                    O = "system_open",
                    Y = "copy_selector",
                    h = "parent_or_close",
